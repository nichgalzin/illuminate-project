...
export const illegalHarms: IllegalHarm[] = [
  ...
  // The fourth illegal harm (drugs) needs to be added by the candidate
];
...
export const riskFactorDescriptions: RiskFactorInfo[] = [
  {
    ...
    description: "Research shows that social media services can increase the risk of all kinds of illegal harm. This may be due to more research on social media services, or greater probability of risk due to the wide range of functionalities and features on many social media services.",
  ...
  },
  {
    ...
    description: "If your service is a marketplace or listings service, you should consider how your service may be used by potential perpetrators to sell or buy illegal goods or services. They are often used in purchase scams in fraud offences and can also be used to raise funds that are used for potentially illegal purposes such as terrorist activities. The ability to make online payments on online marketplaces or listing services can increase the risk of harm.",
