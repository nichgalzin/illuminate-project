...
export interface SafetyMeasure {
  ...
  conditionType:
    | "highRiskCount"
    | "specificHarmHighRisk"
    | "largeServiceAndHighRisk";
  conditionData: {
    minCount?: number;
    harmId?: string;
  };
  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        ...
        {
          value: "postingImages",
          label: "Posting or sending images or videos",
        },
      ],
      type: "checkbox",
    },
...
export const safetyMeasures: SafetyMeasure[] = [
  {
    ...
    description:
      "Implement real-time automated content moderation and expand human review coverage.",
  ...
  },
  {
    ...
    description:
      "Establish a rapid escalation and takedown process for terrorist content, including staff training.",
  ...
  },
  {
    ...
    description:
      "Increase visibility and ease of user reporting tools, with prioritisation for hate-related content.",
  ...
  },
  {
    ...
    description:
      "Limit the ability to post or share images/videos in high-risk contexts or implement pre-screening.",
    conditionType: "specificHarmHighRisk",
    conditionData: {
      harmId: "drugs",
    },
  },
  {
    ...
    description:
      "Introduce keywords detection and friction (e.g., message prompts) in direct messages to reduce abuse",
    conditionType: "specificHarmHighRisk",
    conditionData: {
      harmId: "harassment",
    },
